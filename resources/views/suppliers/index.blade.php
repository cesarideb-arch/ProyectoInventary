...
<head>
    ...
    <style>
        ...
        .input-group-append .btn {
            ...
            background: #000000ff; /* Fondo negro para el botón de búsqueda */
            color: white;
        }
        ...
        .custom-table thead {
            background-color: #000000ff; /* Fondo negro para el encabezado de la tabla */
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center page-header mb-3">
            ...
            <div class="export-buttons">
                <a href="{{ route('suppliers.index', array_merge(request()->query(), ['download' => 'pdf'])) }}" class="btn btn-danger">
                    <i class="fas fa-file-pdf"></i> PDF
                </a>
                <a href="{{ route('suppliers.index', array_merge(request()->query(), ['download' => 'excel'])) }}" class="btn btn-success">
            ...
            <form method="GET" action="{{ route('suppliers.index') }}">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        <button class="btn" type="submit" style="background: #000000ff; color: white;">
        ...
        <div class="table-container">
            ...
            <table class="custom-table">
                ...
                <tbody>
                    @foreach($suppliers as $supplier)
                        <tr>
                            <td data-label="Precio">${{ number_format($supplier['price'], 2, '.', ',') }}</td>
            ...
            <div class="pagination-container">
                ...
                <div class="pagination">
                    @if($currentPage > 1)
                        <a href="{{ route('suppliers.index', ['page' => 1, 'query' => request('query')]) }}" class="btn btn-primary btn-custom-size">
                            <i class="fas fa-angle-double-left"></i>
                        </a>
                        <a href="{{ route('suppliers.index', ['page' => $currentPage - 1, 'query' => request('query')]) }}" class="btn btn-primary btn-custom-size">Anterior</a>
                    @endif
                    ...
                    @for($i = $startPage; $i <= $endPage; $i++)
                        ...
                        @else
                            <a href="{{ route('suppliers.index', ['page' => $i, 'query' => request('query')]) }}" class="btn btn-outline-primary btn-custom-size">{{ $i }}</a>
                        @endif
                    @endfor
                    ...
                    @if($currentPage < $lastPage)
                        <a href="{{ route('suppliers.index', ['page' => $currentPage + 1, 'query' => request('query')]) }}" class="btn btn-primary btn-custom-size">Siguiente</a>
                        <a href="{{ route('suppliers.index', ['page' => $lastPage, 'query' => request('query')]) }}" class="btn btn-primary btn-custom-size">
