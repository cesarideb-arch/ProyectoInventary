...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const setupDeleteForms = () => {
        const deleteForms = document.querySelectorAll('.suppliers-delete-form');
    ...
    const setupPageInputValidation = () => {
        const pageInputs = document.querySelectorAll('.suppliers-page-input');
    ...
    const setupPdfDownload = () => {
        const pdfButtons = document.querySelectorAll('.suppliers-pdf-download, .suppliers-excel-download');
